...
class _emailVerificationState extends State<emailVerification> {
  ...
  void Otp() async {
    ...
    try {
      var response = await dio.post(
        "http://165.232.128.116/vuwala/api/generate_email_otp",
        data: {
          'email': widget.emailv,
        },
      );
                ...
                children: [
                  ...
                  Center(
                    child: Container(
                      ...
                      child: Center(
                        child: Text('we have sent your an SMS with a code to Email.example@gmail.com',
                            style: TextStyle(
                    ...
                    children: [
                      Container(
                        ...
                        child: TextButton(
                          child: Text(
                            'Resend OTP',
                            style: TextStyle(fontSize: 14, fontFamily: 'medium', color: Color(0xff403f3f)),
