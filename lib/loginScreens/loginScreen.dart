...
class _loginScreenState extends State<loginScreen> {
  ...
  Future setUserData() async {
    await setPrefData(
        key: 'user_token', value: jsonData['data']['user_token'].toString());
    Token = await getToken();
    await setPrefData(key: 'device_id', value: deviceID.toString());
    await setPrefData(
        key: 'business_id', value: jsonData['data']['business_id'].toString());
                            ...
                            onTap: () {
                              appleSignIn().then((credential) => {
                                    loginByThirdParty(
                                        ...
                                        fgEmail: credential.email == null
                                            ? credential.userIdentifier
                                                    .substring(0, 8) +
                                                '@gmail.com'
                                            : credential.email,
                                        fgName: credential.givenName == null
                                            ? 'user@' +
                                                credential.userIdentifier
                                                    .substring(0, 4)
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Image(
                                      image: AssetImage(
                                          'images/icons/an_apple-logo.png'),
                                      height: 25,
                                      width: 25,
                                    ),
                                  ),
