          ...
          Padding(
            ...
            child: GestureDetector(
              ...
              child: boolOption == false
                  ? Image(
                      image: AssetImage('images/an_pencil.png'),
                      height: 20.0,
                      width: 20.0,
                    )
                  : Container(),
                                  ...
                                  child: Container(
                                    ...
                                    child: image != null
                                        ...
                                        : profile_pic == null || profile_pic == 'null' || profile_pic == ''
                                            ...
                                            : CachedImageContainer(image: '$baseurl/$profile_pic', height: 100, width: 100, bottomCorner: 60, topCorner: 60, fit: BoxFit.cover, placeholder: 'images/Group 62509.png'),
                                  ),
                                ),
                              ),
                              boolOption == true
                                  ? GestureDetector(
                                      child: Container(
                                        ...
                                        child: CircleAvatar(
                                          backgroundColor: Colors.white,
                                          child: Image.asset('images/an_cam.png', height: 40),
                                        ),
                                      ),
                                      onTap: () {
                                        _imgFromGallery();
                            ...
                            Container(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: "Marjolaine",
                                  hintStyle: TextStyle(fontSize: 15, fontFamily: 'medium', color: Color(0xff3f3e3e)),
                                ),
                              ),
                            ),
                            SizedBox(height: 10),
