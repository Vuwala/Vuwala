...
import 'package:vuwala/Utils/helper.dart';
import 'CardBackLayout.dart';
import 'CardFrontLayout.dart';
...
class _CreditCardState extends State<CreditCard> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    widget.width == null ? cardWidth = MediaQuery.of(context).size.width - 40 : cardWidth = widget.width;
          ...
          children: <Widget>[
            ...
            widget.frontLayout ??
                CardFrontLayout(
                        ...
                        cardTypeIcon: getCardTypeIcon(cardNumber: widget.cardNumber),
