...
import 'package:vuwala/utils/TextVariants.dart';
...
class _EditServiceScreenState extends State<EditServiceScreen> {
  ...
  List<String> _locations = ['1', '2', '3', '4']; // Option 1
  ...
  void EditServiceProfile() async {
    ...
    for (var file in images) {
      ...
      formData.files.addAll([
        MapEntry("service_image[]",
            await MultipartFile.fromFile(file.identifier!, filename: "utsav")),
      ]);
    }
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Icon(Icons.add,
                                          ...
                                          size: 14),
                                      GreyHeading(text: 'Add', fontSize: 10)
                                    ],
                                  ),
                                ),
                              ),
                                      ...
                                      children: [
                                        ClipRRect(
                                          child: imagesan.isNotEmpty
                                              ? CachedImageContainer(
                                                  image:
                                                      'http://159.223.181.226/vuwala/${imagesan[index]}',
                                                  width: 120,
                                                  height: 120,
                                                  topCorner: 4,
                                                  bottomCorner: 0,
                                        ...
                                        Positioned(
                                          ...
                                          child: GestureDetector(
                                            child: Image.asset(
                                                'images/icons/an_close.png',
                                                height: 20,
                                                width: 20),
                                            onTap: () {
                                              setState(() {
                                                imagesan
                                                    .remove(imagesan[index]);
                                              });
                                            },
                                          ),
                                        ),
