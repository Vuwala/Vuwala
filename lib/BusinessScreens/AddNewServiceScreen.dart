...
class _AddNewServiceScreenState extends State<AddNewServiceScreen> {
  ...
  void initState() {
    getData();
    // _dropdownTestItems = buildDropdownTestItems(roleData:category);
    super.initState();
  }
                              ...
                              child: DottedBorder(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [Icon(Icons.add, color: Colors.grey.shade600, size: 14), GreyHeading(text: 'Add', fontSize: 10)],
                                  ),
                                ),
                              ),
                            ),
